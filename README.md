...
Servir la carpeta con cualquier servidor estático (por ejemplo, la extensión Live Server de VS Code, o):
bash
   npx serve .
Abrir la URL indicada por el servidor en el navegador.
